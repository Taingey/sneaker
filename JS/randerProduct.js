...
export function renderProducts() {
  ...
  productsData.map((product) => {
    ...
    productCard.innerHTML = `
      <header class=" border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#" class="pruduct">
        ...
        <div class="px-5 pb-5 flex flex-col ">
            ...
            <div class="flex items-center gap-5 flex-col mt-2.5 mb-5">
